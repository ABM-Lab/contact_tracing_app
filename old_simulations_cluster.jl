...
function create_folder(ip::cv.old_ModelParameters,province="ontario")
    ...
    RF =     RF = string(main_folder,"/rng_old_notif_$(ip.not_swit)","_11_12_n_tests_$(ip.n_tests)","_results_prob_","$(replace(string(round(ip.β,digits=2)), "." => "_"))","_cov_$(round(ip.app_coverage,digits=2))","_comp_$(ip.comp_bool)","_int_$(ip.time_until_testing)","_iso_$(ip.iso_con)") 
...
function old_run_param_scen_cal(b::Float64,province::String="ontario",ic1::Int64=1,index::Int64 = 0,test_time::Int64=0,test_dur::Int64=0,mt::Int64=300,nsims::Int64=500,ps::Int64=100000, app_cov::Float64=0.3, test_cap::Int64=1, i_con::Int64=0,notif::Bool=true,t_sens::Int64=1, ob::Bool = true, ims::Int64=1)
